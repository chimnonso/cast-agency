...
class AgencyTestCase(unittest.TestCase):
	...
	def test_update_actor(self):
		...
		actor_id = 1
		new_name = "New Name"
		res = self.client().patch(f'/actors/{actor_id}', json={'name': new_name}, headers=header_obj)
	...
	def test_update_actor_422(self):
		...
		actor_id = 1
		invalid_actor = {}
		res = self.client().patch(f'/actors/{actor_id}', json=invalid_actor, headers=header_obj)
